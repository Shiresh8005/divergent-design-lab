...
-- Cause: missing tables, failed trigger, or duplicate profile rows

-- Ensure core tables exist (safe if 001 already ran)
...
-- Idempotent signup handler — survives retries and partial state
...
-- Permissions for Supabase Auth to invoke trigger
